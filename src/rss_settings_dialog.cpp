...
// Private -->
namespace Rss_settings_dialog_aux
{
...
Rss_settings_dialog::Rss_settings_dialog(BaseObjectType* cobject, const m::gtk::Builder& builder)
:
	...
	priv( new Private(builder) )
{
	...
	this->signal_response().connect(
		sigc::mem_fun(*this, &Rss_settings_dialog::on_response_cb));
}



void Rss_settings_dialog::init(Gtk::Window& parent_window, Temporary_action action, Torrents_group group)
{
...
Time Rss_settings_dialog::get_time(void) const
{
...
void Rss_settings_dialog::on_response_cb(int response_id) const
{
