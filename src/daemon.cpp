...
Torrent_details Daemon::get_torrent_details(const Torrent_id& torrent_id) const throw(m::Exception)
{
...
std::string Daemon::get_torrent_download_path(const Torrent_id& torrent_id) throw(m::Exception)
{
...
Revision Daemon::get_torrent_files_info(const Torrent_id& torrent_id, std::vector<Torrent_file> *files, std::vector<Torrent_file_status>* statuses, Revision revision) const throw(m::Exception)
{
...
void Daemon::get_torrent_peers_info(const Torrent_id& torrent_id, std::vector<Torrent_peer_info>& peers_info) const throw(m::Exception)
{
...
bool Daemon::get_torrent_new_download_settings(const Torrent_id& torrent_id, Revision* revision, Download_settings* download_settings) const throw(m::Exception)
{
...
bool Daemon::get_torrent_new_trackers(const Torrent_id& torrent_id, Revision* revision, std::vector<std::string>* trackers) const throw(m::Exception)
{
...
void Daemon::resume_torrent(const Torrent_id& torrent_id) throw(m::Exception)
{
...
void Daemon::set_copy_when_finished(const Torrent_id& torrent_id, bool copy, const std::string& to) throw(m::Exception)
{
...
void Daemon::set_files_download_status(const Torrent_id& torrent_id, const std::vector<int>& files_ids, bool download) throw(m::Exception)
{
...
#if 0
void Daemon::set_files_new_paths(const Torrent_id& torrent_id, const std::vector<Torrent_file>& files_new_paths) throw(m::Exception)
{
...
void Daemon::set_files_priority(const Torrent_id& torrent_id, const std::vector<int>& files_ids, const Torrent_file_settings::Priority priority) throw(m::Exception)
{
...
void Daemon::set_sequential_download(const Torrent_id& torrent_id, bool value) throw(m::Exception)
{
...
void Daemon::set_torrent_trackers(const Torrent_id& torrent_id, const std::vector<std::string>& trackers) throw(m::Exception)
{
...
void Daemon::start(void) throw(m::Exception)
{
	try
	{
